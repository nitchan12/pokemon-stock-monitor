...
- **สินค้าตัวหนึ่งถูกถอดออกจากเว็บแล้ว** — `10161784` (กล่อง ฿1,980) ตอนนี้คืนค่า
  HTTP 410 Gone และหายจากหน้าค้นหา จึงถูกเอาออกจากรายการที่เฝ้าดู หากกลับมา
  ขายอีกครั้ง (อาจเป็น URL ใหม่) ต้องเพิ่มเองผ่าน `PRODUCT_URLS` — ระบบปัจจุบัน
  **ไม่ตรวจจับสินค้า MA6 ตัวใหม่ที่เพิ่งขึ้นเว็บ** เพราะเฝ้าเฉพาะ URL ที่ระบุไว้
